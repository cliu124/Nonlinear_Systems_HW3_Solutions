...
sample_num=1000; %This is the sampling number over time for one period
period_num=10; %number of sampling period
t_list=linspace(0,period_num*2*pi/12,period_num*sample_num); %simulation time, as 10 times the period
...
for t_ind=1:length(t_list)
    ...
    A(:,:,t_ind)=[-1-9*cos(6*t)^2+6*sin(12*t), 12*cos(6*t)^2+9/2*sin(12*t);
       -12*sin(6*t)^2+9/2*sin(12*t), -1-9*sin(6*t)^2-6*sin(12*t)]; %A matrix for a time-varying system of Example 4.22 in Khalil's textbook
